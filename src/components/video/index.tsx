    ...
    return (
        <div className={styles.video}>
            <div className={styles.content} ref={videoRef} onClick={handleVideoOpen}>
                <video src="https://res.cloudinary.com/dfxz1hh8s/video/upload/v1710317866/mainVideo_br5ern.mp4" loop autoPlay muted playsInline preload="metadata" />
            ...
            {videoOpen && (
                <motion.div key="videoOpenedId" className={styles.videoModal} initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
                    <video src="https://res.cloudinary.com/dfxz1hh8s/video/upload/v1710317866/mainVideo_br5ern.mp4" controls autoPlay playsInline preload="metadata" />
